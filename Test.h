...
// Sun Nov  6 23:01:45 2022 by ROOT version 6.24/06
// from TTree genevents/TTree containing event generator information
// found on file: AE541A303156F447FEDE4AB9EC424ACF_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmParticles = 15000;
...
//    if (tree == 0) {
//       TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("AE541A303156F447FEDE4AB9EC424ACF_0.root");
//       if (!f || !f->IsOpen()) {
//          f = new TFile("AE541A303156F447FEDE4AB9EC424ACF_0.root");
//       }
...
Test::Test() : fChain(0)
{
   ...
   chain->Add("HijingWithOutQuenching_pthat15/*.root");
   Init(chain);
}
